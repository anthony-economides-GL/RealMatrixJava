...
public class RealMatrixJava {
	...
	//attention au floats : 3.5 et pas 3,5
	static int u=1;
	...
	public static void main(String[] args) {
		...
		//imprimer le tableaux resultat de la premiere multiplication
		...
		//imprimer le tableaux resultat de la deuxieme multiplication
